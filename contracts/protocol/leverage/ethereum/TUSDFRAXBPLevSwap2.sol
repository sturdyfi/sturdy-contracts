...
contract TUSDFRAXBPLevSwap2 is GeneralLevSwap2 {
  ...
  function _processSwap(
    ...
    if (_isFrom) {
      ...
      uint256 minAmount = TUSDFRAXBP.calc_withdraw_one_coin(_amount, int128(coinIndex));
      return TUSDFRAXBP.remove_liquidity_one_coin(_amount, int128(coinIndex), minAmount);
    }
    ...
    IERC20(from).safeApprove(address(TUSDFRAXBP), _amount);
