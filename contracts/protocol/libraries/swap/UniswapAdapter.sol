...
library UniswapAdapter {
  ...
  function swapExactTokensForTokens(
    ...
    bool useEthPath = _useMultihopSwap(addressesProvider, assetToSwapFrom);
  ...
  function _useMultihopSwap(ILendingPoolAddressesProvider addressesProvider, address _asset)
    internal
    view
    returns (bool)
  {
