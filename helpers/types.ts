...
export enum eContractid {
  ...
  StaticATokenImpl = 'StaticATokenImpl',
  AToken = 'AToken',
...
export type iParamsPerNetwork<T> = iEthParamsPerNetwork<T>;
...
export type PoolConfiguration = ICommonConfiguration | IEthConfiguration;
