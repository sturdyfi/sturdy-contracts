...
import { deployMIM3CRVPOracle } from '../../helpers/contracts-deployments';
import {
  ...
  .setAction(async ({ pool, verify }, DRE) => {
    ...
    // cvxMIM_3CRV reserve
    {
      ...
      await provider.connect(signer).setAddressAsProxy(
        ...
        '0xda87577f9eb8B15B26C00619FD06d4485880310D' // vault implement address (CONVEX_MIM_3CRV_VAULT)
      );
      ...
      await waitForTx(
        await vaultHelper.connect(signer).deployVault(
          ...
          [
            ...
            '0xc6DC0Bf66e759d4892AEDA7C9d02eB671F2c3016', // internal asset address (CVXFRAX_3CRV)
          ...
          [
            {
              asset: '0xc6DC0Bf66e759d4892AEDA7C9d02eB671F2c3016',
              baseLTV: '9000',
          ...
          [
            {
              ...
              yieldAddress: '0x0000000000000000000000000000000000000000',
              underlyingAsset: '0xc6DC0Bf66e759d4892AEDA7C9d02eB671F2c3016',
              treasury: '0xFd1D36995d76c0F75bbe4637C84C06E4A68bBB3a',
      ...
      await waitForTx(
        await sturdyOracle
          .connect(signer)
          .setAssetSources(
            [getParamPerNetwork(ReserveAssets, <eNetwork>network).cvxMIM_3CRV],
