...
const deployNewVault = async () => {
  ...
  // FORK=ftm yarn hardhat external:get-param-for-new-vault --pool Fantom --symbol mooTOMB_MIMATIC --impladdress 0xBc6205F61bB8DB1E68c96752d5CFC6CC8EDc1f07 --network localhost
  const _ids = [
