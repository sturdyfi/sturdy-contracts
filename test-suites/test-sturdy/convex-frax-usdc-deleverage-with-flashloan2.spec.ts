...
import { FRAXUSDCLevSwap2, MintableERC20 } from '../../types';
import { ProtocolErrors, tEthereumAddress } from '../../helpers/types';
import { deployFRAXUSDCLevSwap2 } from '../../helpers/contracts-deployments';
...
const getCollateralLevSwapper = async (testEnv: TestEnv, collateral: tEthereumAddress) => {
  const { FRAX_USDC_LP, convexFRAXUSDCVault, addressesProvider } = testEnv;
  return await deployFRAXUSDCLevSwap2([
...
makeSuite('FRAXUSDC Deleverage with Flashloan', (testEnv) => {
  ...
  let fraxusdcLevSwap = {} as FRAXUSDCLevSwap2;
  let ltv = '';
        ...
        reversePaths: [
          {
            ...
            routeParams: [
              [0, 1, 12 /*2-coin-pool add_liquidity*/],
              [0, 0, 0],
              [0, 0, 0],
              [0, 0, 0],
            ] as any,
